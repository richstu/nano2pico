...
namespace xsec{
  ...
  float crossSection(const TString &file, int year){
    ...
    if (year < 2022) {
        ...
        if(file.Contains("TGQB-4FS_TuneCP5_13p6TeV"))                          xsec = 3.873;//XSDB
        ...
        if(file.Contains("ZZto2L2Q_TuneCP5_13p6TeV"))     xsec = 6.788; //XSDB
        if(file.Contains("ZZto2L2Nu_TuneCP5_13p6TeV"))    xsec = 1.031; //XSDB
        if(file.Contains("ZZto4L_TuneCP5_13p6TeV"))       xsec = 1.39; //XSDB
        if(file.Contains("WWto2L2Nu_TuneCP5_13p6TeV"))    xsec = 11.79; //XSDB
        if(file.Contains("WZto2L2Q_TuneCP5_13p6TeV"))     xsec = 7.568; //XSDB
        if(file.Contains("WZto3LNu_TuneCP5_13p6TeV"))     xsec = 4.924; //XSDB
    ...
    if(file.Contains("VBFHToWWTo2L2Nu"))         xsec = HToWW * WToLNu * WToLNu * 3.782;
    if(file.Contains("WminusHToWWTo2L2Nu"))      xsec = HToWW * WToLNu * WToLNu * 0.527;
    ...
    if(file.Contains("HWplusJ_HToWWTo2L2Nu_WTo2L_M-125") && file.Contains("PSweights"))      xsec = HToWW * WToLNu * WToLNu * 0.176;
    ...
    if(file.Contains("WminusHToTauTau"))      xsec = HToTT * xs_wmh;
    if(file.Contains("WplusHToTauTau"))       xsec = HToTT * xs_wph;
    if(file.Contains("ZHToTauTau"))           xsec = HToTT * xs_z_h;
    if(file.Contains("ttHToTauTau"))          xsec = HToTT * xs_tth;

    if(file.Contains("GluGluHToGG"))          xsec = HToGG * xs_ggh;
    if(file.Contains("GluGluHtoGG"))          xsec = HToGG * xs_ggh;
    if(file.Contains("VBFHToGG"))             xsec = HToGG * xs_vbf;
    if(file.Contains("VBFHtoGG"))             xsec = HToGG * xs_vbf;
    if(file.Contains("WminusH_HToGG_WToAll")) xsec = HToGG * xs_wmh;
    if(file.Contains("WplusH_HToGG_WToAll"))  xsec = HToGG * xs_wph;
    if(file.Contains("ZH_HToGG_ZToAll"))      xsec = HToGG * xs_z_h;
    if(file.Contains("ttHJetToGG"))           xsec = HToGG * xs_tth; 
    ...
    if(file.Contains("GluGluHToZZTo4L"))      xsec = HToZZ * ZToLL * ZToLL * xs_ggh ;
    if(file.Contains("GluGluHtoZZto4L"))      xsec = HToZZ * ZToLL * ZToLL * xs_ggh ;
    if(file.Contains("VBFHto2Zto4L_M125"))    xsec = HToZZ * ZToLL * ZToLL * xs_vbf;
    ...
    if(file.Contains("WminusH_HToZZTo2L2X"))          xsec = HToZZ * ZToLL * xs_wmh;
    ...
    if(file.Contains("VBFHtoZG_Zto2L_M-120"))             xsec = H120ToZG * ZToLL / HToZG_onshellfrac * 4.243 ;
    if(file.Contains("WplusH_HToZG_WToAll_ZToLL_M-120"))  xsec = H120ToZG * ZToLL / HToZG_onshellfrac * 0.9558 ;
    if(file.Contains("WplusH_HtoZG_WtoAll_M-120"))        xsec = H120ToZG / HToZG_onshellfrac * 1.042 ; 
    if(file.Contains("WplusH_HtoZG_WtoAll_Zto2L_M-120"))  xsec = H120ToZG * ZToLL / HToZG_onshellfrac * 1.042 ; 
    if(file.Contains("WminusH_HToZG_WToAll_ZToLL_M-120")) xsec = H120ToZG * ZToLL / HToZG_onshellfrac * 0.6092 ;
    if(file.Contains("WminusH_HtoZG_WtoAll_M-120"))       xsec = H120ToZG / HToZG_onshellfrac * 0.6697 ; 
    if(file.Contains("WminusH_HtoZG_WtoAll_Zto2L_M-120")) xsec = H120ToZG * ZToLL / HToZG_onshellfrac * 0.6697 ; 
    if(file.Contains("ZH_HToZG_ZToAll_ZToLL_M-120"))      xsec = H120ToZG * ZToLL / HToZG_onshellfrac * 0.9939 ;
    if(file.Contains("ZH_HtoZG_ZtoAll_M-120"))            xsec = H120ToZG / HToZG_onshellfrac * 1.063 ; 
    if(file.Contains("ZH_ZtoAll_HtoZGto2LG_M-120"))       xsec = H120ToZG * ZToLL / HToZG_onshellfrac * 1.063 ; 
    if(file.Contains("ttHToZG_ZToLL_M-120"))              xsec = H120ToZG * ZToLL / HToZG_onshellfrac * 0.5697 ;
    if(file.Contains("ttHtoZG_Zto2L_M-120"))              xsec = H120ToZG * ZToLL / HToZG_onshellfrac * 0.6412 ;

    if(file.Contains("GluGluHToZG_ZToLL_M-130"))          xsec = H130ToZG * ZToLL / HToZG_onshellfrac * 45.31;
    if(file.Contains("GluGluHtoZG_Zto2L_M-130"))          xsec = H130ToZG * ZToLL / HToZG_onshellfrac * 48.75;
    if(file.Contains("VBFHToZG_ZToLL_M-130"))             xsec = H130ToZG * ZToLL / HToZG_onshellfrac * 3.637 ;
    if(file.Contains("VBFHtoZG_Zto2L_M-130"))             xsec = H130ToZG * ZToLL / HToZG_onshellfrac * 3.925 ;
    if(file.Contains("WplusH_HToZG_WToAll_ZToLL_M-130"))  xsec = H130ToZG * ZToLL / HToZG_onshellfrac * 0.7414 ;
    if(file.Contains("WplusH_HtoZG_WtoAll_M-130"))        xsec = H130ToZG / HToZG_onshellfrac * 0.8142 ; 
    if(file.Contains("WplusH_HtoZG_WtoAll_Zto2L_M-130"))  xsec = H130ToZG * ZToLL / HToZG_onshellfrac * 0.8142 ; 
    ...
    if(file.Contains("WminusH_HtoZG_WtoAll_M-130"))       xsec = H130ToZG / HToZG_onshellfrac * 0.5184 ; 
    if(file.Contains("WminusH_HtoZG_WtoAll_Zto2L_M-130")) xsec = H130ToZG * ZToLL / HToZG_onshellfrac * 0.5184 ; 
    ...
    if(file.Contains("TTtoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8")) xsec = 762.1 * 2.0 * WToLNu * WToQQ;
    if(file.Contains("TWminusto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8")) xsec = 35.99 * WToLNu * WToLNu;
    ...
    // W+Jets background
    if(file.Contains("WJetsToLNu_TuneCP5") && !file.Contains("TTWJetsToLNu"))		xsec=66680; //XSDB
    ...
    // TT+Jets
    // from https://pdg.lbl.gov/2024/reviews/rpp2024-rev-top-quark.pdf
    ...
    if(file.Contains("TTLNu-1Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8"))				xsec=0.2505;
    if(file.Contains("TTLNu-EWK_TuneCP5_13p6TeV_amcatnlo-pythia8"))					xsec=0.01769;
    if(file.Contains("TTTT_TuneCP5_13p6TeV_amcatnlo-pythia8"))						xsec=0.009652;
    if(file.Contains("ttHto2B_M-125_TuneCP5_13p6TeV_powheg-pythia8"))					xsec=0.57*Htobb;

    // WJets
    if(file.Contains("WtoLNu-4Jets_TuneCP5_13p6TeV_madgraphMLM-pythia8"))				xsec=55390;
    if(file.Contains("WtoLNu-4Jets_MLNu-0to120_HT-40to100_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=4254;
    if(file.Contains("WtoLNu-4Jets_MLNu-120_HT-40to100_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=20.56;
    if(file.Contains("WtoLNu-4Jets_MLNu-0to120_HT-100to400_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=1626;
    if(file.Contains("WtoLNu-4Jets_MLNu-120_HT-100to400_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=10.19;
    if(file.Contains("WtoLNu-4Jets_MLNu-0to120_HT-400to800_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=59.99;
    if(file.Contains("WtoLNu-4Jets_MLNu-120_HT-400to800_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=0.5239;
    if(file.Contains("WtoLNu-4Jets_MLNu-0to120_HT-800to1500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=6.23;
    if(file.Contains("WtoLNu-4Jets_MLNu-120_HT-800to1500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=0.06255;
    if(file.Contains("WtoLNu-4Jets_MLNu-0to120_HT-1500to2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=0.4477;
    if(file.Contains("WtoLNu-4Jets_MLNu-120_HT-1500to2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=0.005066;
    if(file.Contains("WtoLNu-4Jets_MLNu-0to120_HT-2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=0.03075;
    if(file.Contains("WtoLNu-4Jets_MLNu-120_HT-2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=0.0003788;

    // ZJets
    if(file.Contains("Zto2Nu-4Jets_HT-100to200_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=273.7;
    if(file.Contains("Zto2Nu-4Jets_HT-200to400_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=75.96;
    if(file.Contains("Zto2Nu-4Jets_HT-400to800_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=13.19;
    if(file.Contains("Zto2Nu-4Jets_HT-800to1500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=1.364;
    if(file.Contains("Zto2Nu-4Jets_HT-1500to2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=0.09865;
    if(file.Contains("Zto2Nu-4Jets_HT-2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=0.006699;

    // QCD
    if(file.Contains("QCD-4Jets_HT-100to200_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=25400000;
    if(file.Contains("QCD-4Jets_HT-200to400_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=1961000;
    if(file.Contains("QCD-4Jets_HT-400to600_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=95620;
    if(file.Contains("QCD-4Jets_HT-600to800_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=13540;
    if(file.Contains("QCD-4Jets_HT-800to1000_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=3033;
    if(file.Contains("QCD-4Jets_HT-1000to1200_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=883.7;
    if(file.Contains("QCD-4Jets_HT-1200to1500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=383.5;
    if(file.Contains("QCD-4Jets_HT-1500to2000_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=125.2;
    if(file.Contains("QCD-4Jets_HT-2000_TuneCP5_13p6TeV_madgraphMLM-pythia8"))				xsec=26.49;

    // Single Top
    // for tW: calculated using xsdb xsec * branching fraction because powheg xsec does not account for decay
    // for t-channel: production xsec from https://twiki.cern.ch/twiki/bin/view/LHCPhysics/SingleTopNNLORef, multiplied by BR
    // for s-channel: xsec already includes decay
    if(file.Contains("TbarWplusto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8"))				xsec=36.05*0.102656;
    if(file.Contains("TbarWplustoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8"))				xsec=36.05*0.431963;
    if(file.Contains("TWminusto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8"))					xsec=35.99*0.102656;
    if(file.Contains("TWminustoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8"))					xsec=35.99*0.431963;
    if(file.Contains("TbarQtoLNu-t-channel_TuneCP5_13p6TeV_powheg-pythia8"))				xsec=87.2*0.3204;
    if(file.Contains("TbarQto2Q-t-channel_TuneCP5_13p6TeV_powheg-pythia8"))				xsec=87.2*0.6741;
    if(file.Contains("TQbartoLNu-t-channel_TuneCP5_13p6TeV_powheg-pythia8"))				xsec=145.0*0.3204;
    if(file.Contains("TQbarto2Q-t-channel_TuneCP5_13p6TeV_powheg-pythia8"))				xsec=145.0*0.6741;
    if(file.Contains("TBbartoLplusNuBbar-s-channel-4FS_TuneCP5_13p6TeV_amcatnlo-pythia8"))		xsec=2.278;
    if(file.Contains("TbarBtoLminusNuB-s-channel-4FS_TuneCP5_13p6TeV_amcatnlo-pythia8"))		xsec=1.43;

    // DY+Jets
    if(file.Contains("DYto2L-4Jets_MLL-50_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=5467;
    if(file.Contains("DYto2L-4Jets_MLL-50to120_HT-70to100_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=140.1;
    if(file.Contains("DYto2L-4Jets_MLL-120_HT-70to100_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=2.205;
    if(file.Contains("DYto2L-4Jets_MLL-50to120_HT-100to400_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=179.6;
    if(file.Contains("DYto2L-4Jets_MLL-120_HT-100to400_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=3.352;
    if(file.Contains("DYto2L-4Jets_MLL-50to120_HT-400to800_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=6.742;
    if(file.Contains("DYto2L-4Jets_MLL-120_HT-400to800_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=0.1757;
    if(file.Contains("DYto2L-4Jets_MLL-50to120_HT-800to1500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=0.693;
    if(file.Contains("DYto2L-4Jets_MLL-120_HT-800to1500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=0.02089;
    if(file.Contains("DYto2L-4Jets_MLL-50to120_HT-1500to2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=0.05047;
    if(file.Contains("DYto2L-4Jets_MLL-120_HT-1500to2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=0.001697;
    if(file.Contains("DYto2L-4Jets_MLL-50to120_HT-2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=0.00346;
    if(file.Contains("DYto2L-4Jets_MLL-120_HT-2500_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=0.0001247;
 
    // GJets
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-10to100_HT-40to100_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=123300;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-100to200_HT-40to200_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=556.4;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-200_HT-40to400_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=43.93;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-10to100_HT-100to200_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=32370;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-10to100_HT-200to400_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=5512;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-100to200_HT-200to400_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=203.1;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-10to100_HT-400to600_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=481.7;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-100to200_HT-400to600_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=29.97;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-200_HT-400to600_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=11.79;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-10to100_HT-600to1000_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=116.6;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-100to200_HT-600to1000_TuneCP5_13p6TeV_madgraphMLM-pythia8"))	xsec=9.634;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-200_HT-600to1000_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=4.756;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-10to100_HT-1000_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=15.1;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-100to200_HT-1000_TuneCP5_13p6TeV_madgraphMLM-pythia8"))		xsec=1.637;
    if(file.Contains("GJ-4Jets_dRGJ-0p25_PTG-200_HT-1000_TuneCP5_13p6TeV_madgraphMLM-pythia8"))			xsec=1.018;

    // diboson 
    // xsec for Higgs production from https://twiki.cern.ch/twiki/bin/view/LHCPhysics/LHCHWG136TeVxsec_extrap
    if(file.Contains("WminusH_Hto2B_WtoLNu_M-125_TuneCP5_13p6TeV_powheg-pythia8"))			xsec=0.5677*Htobb*3*WToLNu;
    if(file.Contains("WplusH_Hto2B_WtoLNu_M-125_TuneCP5_13p6TeV_powheg-pythia8"))			xsec=0.8889*Htobb*3*WToLNu;
    if(file.Contains("WWto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8"))					xsec=11.79;
    if(file.Contains("WWtoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8"))					xsec=48.94;
    if(file.Contains("WZtoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8"))					xsec=15.87;
    if(file.Contains("WZtoL3Nu-1Jets-4FS_TuneCP5_13p6TeV_amcatnloFXFX-pythia8"))			xsec=3.445;
    if(file.Contains("WZto2L2Q_TuneCP5_13p6TeV_powheg-pythia8"))					xsec=7.568;
    if(file.Contains("WZto3LNu_TuneCP5_13p6TeV_powheg-pythia8"))					xsec=4.924;
  ...
  float fractionNegWeights(const TString &file){
    ...
    // fneg for 13.6TeV 4b background samples (all obtained from XSDB)
    if(file.Contains("TTG-1Jets_PTG-10to100_TuneCP5_13p6TeV_amcatnloFXFXold-pythia8"))		fneg=0.295;
    if(file.Contains("TTG-1Jets_PTG-100to200_TuneCP5_13p6TeV_amcatnloFXFXold-pythia8"))		fneg=0.3014;
    if(file.Contains("TTG-1Jets_PTG-200_TuneCP5_13p6TeV_amcatnloFXFXold-pythia8"))		fneg=0.3212;
    if(file.Contains("TTLL_MLL-4to50_TuneCP5_13p6TeV_amcatnlo-pythia8"))			fneg=0.225;
    if(file.Contains("TTLL_MLL-50_TuneCP5_13p6TeV_amcatnlo-pythia8"))				fneg=0.2396;
    if(file.Contains("TTZ-ZtoQQ-1Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8"))			fneg=0.303;
    if(file.Contains("TTLNu-1Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8"))			fneg=0.2419;
    if(file.Contains("TTLNu-EWK_TuneCP5_13p6TeV_amcatnlo-pythia8"))				fneg=0.01729;
    if(file.Contains("TTTT_TuneCP5_13p6TeV_amcatnlo-pythia8"))					fneg=0.2743;
    if(file.Contains("ttHto2B_M-125_TuneCP5_13p6TeV_powheg-pythia8"))				fneg=0.01054;

    if(file.Contains("TbarWplusto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8"))			fneg=0.000009963;
    if(file.Contains("TWminustoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8"))				fneg=0.00003999;
    if(file.Contains("TWminusto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8"))				fneg=0.00001989;
    if(file.Contains("TbarQtoLNu-t-channel_TuneCP5_13p6TeV_powheg-pythia8"))			fneg=0.002817;
    if(file.Contains("TbarQto2Q-t-channel_TuneCP5_13p6TeV_powheg-pythia8"))			fneg=0.002346;
    if(file.Contains("TQbarto2Q-t-channel_TuneCP5_13p6TeV_powheg-pythia8"))			fneg=0.002812;
    if(file.Contains("TQbartoLNu-t-channel_TuneCP5_13p6TeV_powheg-pythia8"))			fneg=0.002728;
    ...
    if(file.Contains("WWto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8"))				fneg=0.0001096;
    if(file.Contains("WWtoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8"))				fneg=0.00009933;
    if(file.Contains("WZtoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8"))				fneg=0.0002186;
  ...
  void higgsino2DCrossSection(int hig_mass, double &xsec, double &xsec_unc, int year) {
    if((year == 2022 || year == 2023)){
      ...
      else if(hig_mass == 250) { xsec = 0.1183; xsec_unc = 0.038328; return;}
      //else if(hig_mass == 275) { xsec = 0.0719125; xsec_unc = 0.0549666; return;}
      else if(hig_mass == 300) { xsec = 0.05807; xsec_unc = 0.041593; return;}
      //else if(hig_mass == 325) { xsec = 0.0369715; xsec_unc = 0.0590317; return;}
      else if(hig_mass == 350) { xsec = 0.03123; xsec_unc = 0.045398; return;}
      //else if(hig_mass == 375) { xsec = 0.0205429; xsec_unc = 0.0625031; return;}
      else if(hig_mass == 400) { xsec = 0.01794; xsec_unc = 0.049254; return;}
      //else if(hig_mass == 425) { xsec = 0.0120965; xsec_unc = 0.0657801; return;}
      else if(hig_mass == 450) { xsec = 0.01084; xsec_unc = 0.053235; return;}
      //else if(hig_mass == 475) { xsec = 0.00743587; xsec_unc = 0.0686033; return;}
      else if(hig_mass == 500) { xsec = 0.006805; xsec_unc = 0.05714; return;}
      //else if(hig_mass == 525) { xsec = 0.00473235; xsec_unc = 0.0713166; return;}
      else if(hig_mass == 550) { xsec = 0.00441; xsec_unc = 0.062129; return;}
      //else if(hig_mass == 575) { xsec = 0.00309847; xsec_unc = 0.0739435; return;}
      else if(hig_mass == 600) { xsec = 0.002932; xsec_unc = 0.067067; return;}
      //else if(hig_mass == 625) { xsec = 0.00207755; xsec_unc = 0.0763142; return;}
      else if(hig_mass == 650) { xsec = 0.001992; xsec_unc = 0.072062; return;}
      //else if(hig_mass == 675) { xsec = 0.0014199; xsec_unc = 0.0782907; return;}
      else if(hig_mass == 700) { xsec = 0.001378; xsec_unc = 0.077026; return;}
      //else if(hig_mass == 725) { xsec = 0.00098639; xsec_unc = 0.0809291; return;}
      else if(hig_mass == 750) { xsec = 0.0009678; xsec_unc = 0.083024; return;}
      //else if(hig_mass == 775) { xsec = 0.000694985; xsec_unc = 0.0841352; return;}
      else if(hig_mass == 800) { xsec = 0.0006891; xsec_unc = 0.090089; return;}
      //else if(hig_mass == 825) { xsec = 0.000495914; xsec_unc = 0.0863944; return;}
      else if(hig_mass == 850) { xsec = 0.0004964; xsec_unc = 0.098082; return;}
      //else if(hig_mass == 875) { xsec = 0.000361029; xsec_unc = 0.0888678; return;}
      else if(hig_mass == 900) { xsec = 0.0003613; xsec_unc = 0.106042; return;}
      //else if(hig_mass == 925) { xsec = 0.000262621; xsec_unc = 0.0913227; return;}
      else if(hig_mass == 950) { xsec = 0.0002654; xsec_unc = 0.116039; return;}
      //else if(hig_mass == 975) { xsec = 0.0001909; xsec_unc = 0.0937616; return;}
      else if(hig_mass == 1000) { xsec = 0.0001966; xsec_unc = 0.127035; return;}
      //else if(hig_mass == 1025) { xsec = 0.00014139; xsec_unc = 0.095765; return;}
      else if(hig_mass == 1050) { xsec = 0.0001466; xsec_unc = 0.139032; return;}
      //else if(hig_mass == 1075) { xsec = 0.000105913; xsec_unc = 0.0978621; return;}
      else if(hig_mass == 1100) { xsec = 0.0001101; xsec_unc = 0.153029; return;}
      //else if(hig_mass == 1125) { xsec = 7.93058e-05; xsec_unc = 0.0999433; return;}
      else if(hig_mass == 1150) { xsec = 8.317e-05; xsec_unc = 0.168027; return;}
      //else if(hig_mass == 1175) { xsec = 5.93602e-05; xsec_unc = 0.10201; return;}
      else if(hig_mass == 1200) { xsec = 6.318e-05; xsec_unc = 0.185024; return;}
      //else if(hig_mass == 1225) { xsec = 4.4906e-05; xsec_unc = 0.104071; return;}
      else if(hig_mass == 1250) { xsec = 4.823e-05; xsec_unc = 0.205022; return;}
      //else if(hig_mass == 1275) { xsec = 3.43135e-05; xsec_unc = 0.10615; return;}
      else if(hig_mass == 1300) { xsec = 3.699e-05; xsec_unc = 0.22702; return;}
      //else if(hig_mass == 1325) { xsec = 2.62223e-05; xsec_unc = 0.108061; return;}
      else if(hig_mass == 1350) { xsec = 2.85e-05; xsec_unc = 0.251018; return;}
      //else if(hig_mass == 1375) { xsec = 2.00393e-05; xsec_unc = 0.109789; return;}
      else if(hig_mass == 1400) { xsec = 2.204e-05; xsec_unc = 0.278016; return;}
      //else if(hig_mass == 1425) { xsec = 1.53144e-05; xsec_unc = 0.11145; return;}
      else if(hig_mass == 1450) { xsec = 1.711e-05; xsec_unc = 0.308015; return;}
      //else if(hig_mass == 1475) { xsec = 1.17047e-05; xsec_unc = 0.113027; return;}
      else{ xsec = 0; xsec_unc = 0;}
    }
    else{
      if(hig_mass == 127) { xsec = 1.44725; xsec_unc = 0.0395277; return;}
      else if(hig_mass == 150) { xsec = 0.71514; xsec_unc = 0.0421496; return;}
      else if(hig_mass == 175) { xsec = 0.419059; xsec_unc = 0.0453279; return;}
      else if(hig_mass == 200) { xsec = 0.244213; xsec_unc = 0.047925; return;}
      else if(hig_mass == 225) { xsec = 0.156286; xsec_unc = 0.0502876; return;}
      else if(hig_mass == 250) { xsec = 0.104252; xsec_unc = 0.0526169; return;}
      else if(hig_mass == 275) { xsec = 0.0719125; xsec_unc = 0.0549666; return;}
      else if(hig_mass == 300) { xsec = 0.0509994; xsec_unc = 0.0572762; return;}
      else if(hig_mass == 325) { xsec = 0.0369715; xsec_unc = 0.0590317; return;}
      else if(hig_mass == 350) { xsec = 0.0273286; xsec_unc = 0.0607766; return;}
      else if(hig_mass == 375) { xsec = 0.0205429; xsec_unc = 0.0625031; return;}
      else if(hig_mass == 400) { xsec = 0.0156691; xsec_unc = 0.0642085; return;}
      else if(hig_mass == 425) { xsec = 0.0120965; xsec_unc = 0.0657801; return;}
      else if(hig_mass == 450) { xsec = 0.00944017; xsec_unc = 0.0674544; return;}
      else if(hig_mass == 475) { xsec = 0.00743587; xsec_unc = 0.0686033; return;}
      else if(hig_mass == 500) { xsec = 0.00590757; xsec_unc = 0.0699909; return;}
      else if(hig_mass == 525) { xsec = 0.00473235; xsec_unc = 0.0713166; return;}
      else if(hig_mass == 550) { xsec = 0.0038167; xsec_unc = 0.0722834; return;}
      else if(hig_mass == 575) { xsec = 0.00309847; xsec_unc = 0.0739435; return;}
      else if(hig_mass == 600) { xsec = 0.00253015; xsec_unc = 0.0754291; return;}
      else if(hig_mass == 625) { xsec = 0.00207755; xsec_unc = 0.0763142; return;}
      else if(hig_mass == 650) { xsec = 0.00171418; xsec_unc = 0.0775695; return;}
      else if(hig_mass == 675) { xsec = 0.0014199; xsec_unc = 0.0782907; return;}
      else if(hig_mass == 700) { xsec = 0.00118113; xsec_unc = 0.0796388; return;}
      else if(hig_mass == 725) { xsec = 0.00098639; xsec_unc = 0.0809291; return;}
      else if(hig_mass == 750) { xsec = 0.000826366; xsec_unc = 0.081879; return;}
      else if(hig_mass == 775) { xsec = 0.000694985; xsec_unc = 0.0841352; return;}
      else if(hig_mass == 800) { xsec = 0.000586211; xsec_unc = 0.0862527; return;}
      else if(hig_mass == 825) { xsec = 0.000495914; xsec_unc = 0.0863944; return;}
      else if(hig_mass == 850) { xsec = 0.000420556; xsec_unc = 0.085742; return;}
      else if(hig_mass == 875) { xsec = 0.000361029; xsec_unc = 0.0888678; return;}
      else if(hig_mass == 900) { xsec = 0.000305935; xsec_unc = 0.0912439; return;}
      else if(hig_mass == 925) { xsec = 0.000262621; xsec_unc = 0.0913227; return;}
      else if(hig_mass == 950) { xsec = 0.00022285; xsec_unc = 0.0919538; return;}
      else if(hig_mass == 975) { xsec = 0.0001909; xsec_unc = 0.0937616; return;}
      else if(hig_mass == 1000) { xsec = 0.00016428; xsec_unc = 0.0954285; return;}
      else if(hig_mass == 1025) { xsec = 0.00014139; xsec_unc = 0.095765; return;}
      else if(hig_mass == 1050) { xsec = 0.000121865; xsec_unc = 0.0967595; return;}
      else if(hig_mass == 1075) { xsec = 0.000105913; xsec_unc = 0.0978621; return;}
      else if(hig_mass == 1100) { xsec = 9.12469e-05; xsec_unc = 0.0964142; return;}
      else if(hig_mass == 1125) { xsec = 7.93058e-05; xsec_unc = 0.0999433; return;}
      else if(hig_mass == 1150) { xsec = 6.84561e-05; xsec_unc = 0.103594; return;}
      else if(hig_mass == 1175) { xsec = 5.93602e-05; xsec_unc = 0.10201; return;}
      else if(hig_mass == 1200) { xsec = 5.16263e-05; xsec_unc = 0.102499; return;}
      else if(hig_mass == 1225) { xsec = 4.4906e-05; xsec_unc = 0.104071; return;}
      else if(hig_mass == 1250) { xsec = 3.91587e-05; xsec_unc = 0.104736; return;}
      else if(hig_mass == 1275) { xsec = 3.43135e-05; xsec_unc = 0.10615; return;}
      else if(hig_mass == 1300) { xsec = 2.99353e-05; xsec_unc = 0.10783; return;}
      else if(hig_mass == 1325) { xsec = 2.62223e-05; xsec_unc = 0.108061; return;}
      else if(hig_mass == 1350) { xsec = 2.28072e-05; xsec_unc = 0.109427; return;}
      else if(hig_mass == 1375) { xsec = 2.00393e-05; xsec_unc = 0.109789; return;}
      else if(hig_mass == 1400) { xsec = 1.75031e-05; xsec_unc = 0.111631; return;}
      else if(hig_mass == 1425) { xsec = 1.53144e-05; xsec_unc = 0.11145; return;}
      else if(hig_mass == 1450) { xsec = 1.34572e-05; xsec_unc = 0.11084; return;}
      else if(hig_mass == 1475) { xsec = 1.17047e-05; xsec_unc = 0.113027; return;}
      else{ xsec = 0; xsec_unc = 0;}      
    }
  }
  ...
  void higgsinoCrossSection(int hig_mass, double &xsec, double &xsec_unc, int year) {
    if((year == 2022 || year == 2023)){ // note: these are 2D xsecs from https://twiki.cern.ch/twiki/bin/view/LHCPhysics/SUSYCrossSections13x6TeVhinosplit
      ...
      else if(hig_mass ==250) { xsec = 0.1183; xsec_unc = 0.036401; return;}
      //else if(hig_mass ==275) { xsec = 0.400107; xsec_unc = 0.0560232; return;}
      else if(hig_mass ==300) { xsec = 0.05807; xsec_unc = 0.038328; return;}
      //else if(hig_mass ==325) { xsec = 0.20736; xsec_unc = 0.0613554; return;}
      else if(hig_mass ==350) { xsec = 0.03123; xsec_unc = 0.041593; return;}
      //else if(hig_mass ==375) { xsec = 0.116006; xsec_unc = 0.066892; return;}
      else if(hig_mass ==400) { xsec = 0.01794; xsec_unc = 0.049254; return;}
      //else if(hig_mass ==425) { xsec = 0.0686963; xsec_unc = 0.0723531; return;}
      else if(hig_mass ==450) { xsec = 0.01084; xsec_unc = 0.053235; return;}
      //else if(hig_mass ==475) { xsec = 0.0424699; xsec_unc = 0.0775146; return;}
      else if(hig_mass ==500) { xsec = 0.006805; xsec_unc = 0.05714; return;}
      //else if(hig_mass ==525) { xsec = 0.0271867; xsec_unc = 0.0825803; return;}
      else if(hig_mass ==550) { xsec = 0.00441; xsec_unc = 0.062129; return;}
      //else if(hig_mass ==575) { xsec = 0.0179062; xsec_unc = 0.087561; return;}
      else if(hig_mass ==600) { xsec = 0.002932; xsec_unc = 0.067067; return;}
      //else if(hig_mass ==625) { xsec = 0.012062; xsec_unc = 0.091959; return;}
      else if(hig_mass ==650) { xsec = 0.001992; xsec_unc = 0.072062; return;}
      //else if(hig_mass ==675) { xsec = 0.00828246; xsec_unc = 0.0957436; return;}
      else if(hig_mass ==700) { xsec = 0.001378; xsec_unc = 0.077026; return;}
      //else if(hig_mass ==725) { xsec = 0.00578355; xsec_unc = 0.0999915; return;}
      else if(hig_mass ==750) { xsec = 0.0009678; xsec_unc = 0.083024; return;}
      //else if(hig_mass ==775) { xsec = 0.00409781; xsec_unc = 0.104646; return;}
      else if(hig_mass ==800) { xsec = 0.0006891; xsec_unc = 0.090089; return;}
      //else if(hig_mass ==825) { xsec = 0.0029337; xsec_unc = 0.108353; return;}
      else if(hig_mass ==850) { xsec = 0.0004964; xsec_unc = 0.098082; return;}
      //else if(hig_mass ==875) { xsec = 0.00213679; xsec_unc = 0.112636; return;}
      else if(hig_mass ==900) { xsec = 0.0003613; xsec_unc = 0.106042; return;}
      //else if(hig_mass ==925) { xsec = 0.00155453; xsec_unc = 0.116949; return;}
      else if(hig_mass ==950) { xsec = 0.0002654; xsec_unc = 0.116039; return;}
      //else if(hig_mass ==975) { xsec = 0.00112975; xsec_unc = 0.121244; return;}
      else if(hig_mass ==1000) { xsec = 0.0001966; xsec_unc = 0.127035; return;}
      //else if(hig_mass ==1025) { xsec = 0.000840602; xsec_unc = 0.121654; return;}
      else if(hig_mass ==1050) { xsec = 0.0001466; xsec_unc = 0.139032; return;}
      //else if(hig_mass ==1075) { xsec = 0.000627083; xsec_unc = 0.127723; return;}
      else if(hig_mass ==1100) { xsec = 0.0001101; xsec_unc = 0.153029; return;}
      //else if(hig_mass ==1125) { xsec = 0.00046747; xsec_unc = 0.133755; return;}
      else if(hig_mass ==1150) { xsec = 8.317e-05; xsec_unc = 0.168027; return;}
      //else if(hig_mass ==1175) { xsec = 0.000348261; xsec_unc = 0.139744; return;}
      else if(hig_mass ==1200) { xsec = 6.318e-05; xsec_unc = 0.185024; return;}
      //else if(hig_mass ==1225) { xsec = 0.000265935; xsec_unc = 0.137575; return;}
      else if(hig_mass ==1250) { xsec = 4.823e-05; xsec_unc = 0.205022; return;}
      //else if(hig_mass ==1275) { xsec = 0.000190411; xsec_unc = 0.138061; return;}
      else if(hig_mass ==1300) { xsec = 3.699e-05; xsec_unc = 0.22702; return;}
      //else if(hig_mass ==1325) { xsec = 0.000136272; xsec_unc = 0.138533; return;}
      else if(hig_mass ==1350) { xsec = 2.85e-05; xsec_unc = 0.251018; return;}
      //else if(hig_mass ==1375) { xsec = 9.74728e-05; xsec_unc = 0.138992; return;}
      else if(hig_mass ==1400) { xsec = 2.204e-05; xsec_unc = 0.278016; return;}
      //else if(hig_mass ==1425) { xsec = 6.96843e-05; xsec_unc = 0.139439; return;}
      else if(hig_mass ==1450) { xsec = 1.711e-05; xsec_unc = 0.308015; return;}
      //else if(hig_mass ==1475) { xsec = 4.98006e-05; xsec_unc = 0.139874; return;}
      else{ xsec = 0; xsec_unc = 0;}      
    }
    else{
      if(hig_mass ==127) { xsec = 7.6022; xsec_unc = 0.0393921; return;}
      ...
      else if(hig_mass ==200) { xsec = 1.33562; xsec_unc = 0.0474362; return;}
      else if(hig_mass ==225) { xsec = 0.860597; xsec_unc = 0.0504217; return;}
      else if(hig_mass ==250) { xsec = 0.577314; xsec_unc = 0.0532731; return;}
      else if(hig_mass ==275) { xsec = 0.400107; xsec_unc = 0.0560232; return;}
      else if(hig_mass ==300) { xsec = 0.284855; xsec_unc = 0.0586867; return;}
      else if(hig_mass ==325) { xsec = 0.20736; xsec_unc = 0.0613554; return;}
      else if(hig_mass ==350) { xsec = 0.153841; xsec_unc = 0.0640598; return;}
      else if(hig_mass ==375) { xsec = 0.116006; xsec_unc = 0.066892; return;}
      else if(hig_mass ==400) { xsec = 0.0887325; xsec_unc = 0.0697517; return;}
      else if(hig_mass ==425) { xsec = 0.0686963; xsec_unc = 0.0723531; return;}
      else if(hig_mass ==450) { xsec = 0.0537702; xsec_unc = 0.0748325; return;}
      else if(hig_mass ==475) { xsec = 0.0424699; xsec_unc = 0.0775146; return;}
      else if(hig_mass ==500) { xsec = 0.0338387; xsec_unc = 0.0802572; return;}
      else if(hig_mass ==525) { xsec = 0.0271867; xsec_unc = 0.0825803; return;}
      else if(hig_mass ==550) { xsec = 0.0219868; xsec_unc = 0.0849278; return;}
      else if(hig_mass ==575) { xsec = 0.0179062; xsec_unc = 0.087561; return;}
      else if(hig_mass ==600) { xsec = 0.0146677; xsec_unc = 0.0900693; return;}
      else if(hig_mass ==625) { xsec = 0.012062; xsec_unc = 0.091959; return;}
      else if(hig_mass ==650) { xsec = 0.00996406; xsec_unc = 0.094065; return;}
      else if(hig_mass ==675) { xsec = 0.00828246; xsec_unc = 0.0957436; return;}
      else if(hig_mass ==700) { xsec = 0.00689981; xsec_unc = 0.0982894; return;}
      else if(hig_mass ==725) { xsec = 0.00578355; xsec_unc = 0.0999915; return;}
      else if(hig_mass ==750) { xsec = 0.0048731; xsec_unc = 0.101211; return;}
      else if(hig_mass ==775) { xsec = 0.00409781; xsec_unc = 0.104646; return;}
      else if(hig_mass ==800) { xsec = 0.00346143; xsec_unc = 0.107618; return;}
      else if(hig_mass ==825) { xsec = 0.0029337; xsec_unc = 0.108353; return;}
      else if(hig_mass ==850) { xsec = 0.0024923; xsec_unc = 0.110016; return;}
      else if(hig_mass ==875) { xsec = 0.00213679; xsec_unc = 0.112636; return;}
      else if(hig_mass ==900) { xsec = 0.00180616; xsec_unc = 0.1134; return;}
      else if(hig_mass ==925) { xsec = 0.00155453; xsec_unc = 0.116949; return;}
      else if(hig_mass ==950) { xsec = 0.00132692; xsec_unc = 0.117027; return;}
      else if(hig_mass ==975) { xsec = 0.00112975; xsec_unc = 0.121244; return;}
      else if(hig_mass ==1000) { xsec = 0.000968853; xsec_unc = 0.126209; return;}
      else if(hig_mass ==1025) { xsec = 0.000840602; xsec_unc = 0.121654; return;}
      else if(hig_mass ==1050) { xsec = 0.000731306; xsec_unc = 0.118502; return;}
      else if(hig_mass ==1075) { xsec = 0.000627083; xsec_unc = 0.127723; return;}
      else if(hig_mass ==1100) { xsec = 0.000538005; xsec_unc = 0.134099; return;}
      else if(hig_mass ==1125) { xsec = 0.00046747; xsec_unc = 0.133755; return;}
      else if(hig_mass ==1150) { xsec = 0.000405108; xsec_unc = 0.120607; return;}
      else if(hig_mass ==1175) { xsec = 0.000348261; xsec_unc = 0.139744; return;}
      else if(hig_mass ==1200) { xsec = 0.000299347; xsec_unc = 0.162604; return;}
      else if(hig_mass ==1225) { xsec = 0.000265935; xsec_unc = 0.137575; return;}
      else if(hig_mass ==1250) { xsec = 0.000240471; xsec_unc = 0.119271; return;}
      else if(hig_mass ==1275) { xsec = 0.000190411; xsec_unc = 0.138061; return;}
      else if(hig_mass ==1300) { xsec = 0.000160765; xsec_unc = 0.122224; return;}
      else if(hig_mass ==1325) { xsec = 0.000136272; xsec_unc = 0.138533; return;}
      else if(hig_mass ==1350) { xsec = 0.000111174; xsec_unc = 0.177681; return;}
      else if(hig_mass ==1375) { xsec = 9.74728e-05; xsec_unc = 0.138992; return;}
      else if(hig_mass ==1400) { xsec = 7.80263e-05; xsec_unc = 0.118718; return;}
      else if(hig_mass ==1425) { xsec = 6.96843e-05; xsec_unc = 0.139439; return;}
      else if(hig_mass ==1450) { xsec = 6.96962e-05; xsec_unc = 0.198887; return;}
      else if(hig_mass ==1475) { xsec = 4.98006e-05; xsec_unc = 0.139874; return;}
      else{ xsec = 0; xsec_unc = 0;}
    }
  }
