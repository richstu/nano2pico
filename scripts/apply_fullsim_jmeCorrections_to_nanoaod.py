...
jmeCorrections = createJMECorrector(isMC=True, dataYear=args.year, runPeriod="A", jesUncert="Total", jetType="AK4PFchs", noGroom=False, metBranchName=metBranchName, applySmearing=True, isFastSim=False)
