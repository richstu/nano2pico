...
def processData(YEAR, PRODUCTION_NAME, STEP_FILEBASENAME, LOG_FILENAME, PICO_DIR, NANOAOD_VERSION, FIRST_COMMAND, notify_script):
  ...
  process_commands = [
    ...
    'ln -s '+PICO_DIR+'/'+NANOAOD_VERSION+'/nano/'+YEAR+'/data/raw_pico '+PICO_DIR+'/'+NANOAOD_VERSION+'/nano/'+YEAR+'/data/unskimmed'],
...
''', formatter_class=argparse.RawTextHelpFormatter)
  ...
  os.system("find "+PICO_DIR+"/"+NANOAOD_VERSION+" -type d -exec chmod 775 {} \;")

  sys.exit()


  FIRST_COMMAND = processMc(YEAR=2016, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME=PICO_DIR+'/'+NANOAOD_VERSION+'/'+PRODUCTION_NAME+'/produce_zgamma_picos.py.'+PRODUCTION_NAME+'.2016.mc.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  #FIRST_COMMAND = processMc(YEAR=2017, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME=PICO_DIR+'/'+NANOAOD_VERSION+'/'+PRODUCTION_NAME+'/produce_zgamma_picos.py.'+PRODUCTION_NAME+'.2017.mc.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  #FIRST_COMMAND = processMc(YEAR=2018, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME=PICO_DIR+'/'+NANOAOD_VERSION+'/'+PRODUCTION_NAME+'/produce_zgamma_picos.py.'+PRODUCTION_NAME+'.2018.mc.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)

  FIRST_COMMAND = processData(YEAR=2016, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME=PICO_DIR+'/'+NANOAOD_VERSION+'/'+PRODUCTION_NAME+'/produce_zgamma_picos.py.'+PRODUCTION_NAME+'.2016.data.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  #FIRST_COMMAND = processData(YEAR=2017, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME=PICO_DIR+'/'+NANOAOD_VERSION+'/'+PRODUCTION_NAME+'/produce_zgamma_picos.py.'+PRODUCTION_NAME+'.2017.data.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  #FIRST_COMMAND = processData(YEAR=2018, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME=PICO_DIR+'/'+NANOAOD_VERSION+'/'+PRODUCTION_NAME+'/produce_zgamma_picos.py.'+PRODUCTION_NAME+'.2018.data.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)

  print ("\n[Info] Restoring git to master")
  ## Return to master
  output, error = runCommand('git checkout master')
  if 'Aborting' in error:
    print("[Error] Could not checkout master. Existing")
  #'git checkout master'

  sys.exit()


  PICO_DIR = '/net/cms24/cms24r0/pico'
  SIGNAL_FOLDER_NAME = "SMS-TChiHH_2D_fastSimJmeCorrection"

  FIRST_COMMAND = processSignal(YEAR=2016, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME='process_steps_higgsino.py.'+PRODUCTION_NAME+'.2016.sig.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, SIGNAL_FOLDER_NAME=SIGNAL_FOLDER_NAME, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  FIRST_COMMAND = processSignal(YEAR=2017, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME='process_steps_higgsino.py.'+PRODUCTION_NAME+'.2017.sig.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, SIGNAL_FOLDER_NAME=SIGNAL_FOLDER_NAME, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  FIRST_COMMAND = processSignal(YEAR=2018, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME='process_steps_higgsino.py.'+PRODUCTION_NAME+'.2018.sig.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, SIGNAL_FOLDER_NAME=SIGNAL_FOLDER_NAME, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)

  PICO_DIR = '/net/cms24/cms24r0/pico'
  SIGNAL_FOLDER_NAME = "SMS-T5qqqqZH_fastSimJmeCorrection"

  FIRST_COMMAND = processSignal(YEAR=2016, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME='process_steps_higgsino.py.'+PRODUCTION_NAME+'.2016.sigGlu.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, SIGNAL_FOLDER_NAME=SIGNAL_FOLDER_NAME, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  FIRST_COMMAND = processSignal(YEAR=2017, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME='process_steps_higgsino.py.'+PRODUCTION_NAME+'.2017.sigGlu.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, SIGNAL_FOLDER_NAME=SIGNAL_FOLDER_NAME, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  FIRST_COMMAND = processSignal(YEAR=2018, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME='process_steps_higgsino.py.'+PRODUCTION_NAME+'.2018.sigGlu.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, SIGNAL_FOLDER_NAME=SIGNAL_FOLDER_NAME, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)

  PICO_DIR = '/net/cms24/cms24r0/pico'
  SIGNAL_FOLDER_NAME = "SMS-T5qqqqZH_FullSim"
  FIRST_COMMAND = processSignal(YEAR=2016, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME='process_steps_higgsino.py.'+PRODUCTION_NAME+'.2016.sigGluFullSim.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, SIGNAL_FOLDER_NAME=SIGNAL_FOLDER_NAME, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  FIRST_COMMAND = processSignal(YEAR=2017, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME='process_steps_higgsino.py.'+PRODUCTION_NAME+'.2017.sigGluFullSim.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, SIGNAL_FOLDER_NAME=SIGNAL_FOLDER_NAME, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
  FIRST_COMMAND = processSignal(YEAR=2018, PRODUCTION_NAME=PRODUCTION_NAME, STEP_FILEBASENAME='process_steps_higgsino.py.'+PRODUCTION_NAME+'.2018.sigGluFullSim.step', PICO_DIR=PICO_DIR, NANOAOD_VERSION=NANOAOD_VERSION, SIGNAL_FOLDER_NAME=SIGNAL_FOLDER_NAME, FIRST_COMMAND=FIRST_COMMAND, notify_script=notify_script)
